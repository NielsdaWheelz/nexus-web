...
export default function WalknoteReviewPanel({
  ...
  useHistoryDismiss(true, onClose, { isTopmost: overlay.isTopmost });
  ...
  return (
    <ModalLayerProvider token={overlay.layerToken}>
      ...
      >
        ...
        >
          <div
            className={styles.playerTask}
            role={playerTask ? "region" : undefined}
            aria-label={playerTask ? "Media player" : undefined}
          >
            ...
            {waypoints.length === 0 ? (
              ...
              <ul
                ...
                aria-label="Session waypoints"
              >
                {waypoints.map((waypoint) => {
                  const discarded = discardedIds.has(waypoint.id);
                  const timestampLabel =
                    formatTranscriptTimestampMs(waypoint.position_ms) ??
                    "0:00:00";
                  ...
                  return (
                    ...
                    >
                      ...
                      <Button
                        ...
                        aria-label={
                          discarded
                            ? `Keep waypoint at ${timestampLabel}`
                            : `Discard waypoint at ${timestampLabel}`
                        }
