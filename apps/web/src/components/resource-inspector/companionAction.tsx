...
// The ONE shared inspector disclosure action (A12/A14 §152) — the single header
...
// selected import's details on the Imports pane. This factory is the sole
// owner of its label, icon (`panel-right`, the same in both states) and
// disclosure state; when expanded its `controls` is that column's region id so
  ...
  return {
    ...
    state: expanded
      ? {
          ...
          expanded: true,
          controls: regionId,
          menuLabels: INSPECTOR_MENU_LABELS,
        }
      : {
          kind: "disclosure",
          expanded: false,
