...
describe("GET /api/artifacts/[artifactId]/exports", () => {
  beforeEach(() => {
  ...
  it("proxies artifact export ledgers to the canonical backend path", async () => {
    ...
    const response = await GET(
      new Request("http://localhost:3000/api/artifacts/artifact-1/exports", {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "http://fastapi.test/artifacts/artifact-1/exports",
