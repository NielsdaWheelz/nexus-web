  ...
  return (
    <EntryCanvas>
      <article className={styles.article}>
        ...
        <p>
          These Terms of Service govern your access to and use of Nexus. By
          using Nexus, you agree to these terms.
        </p>

        <h2>Acceptable use</h2>
        <p>
          Do not use Nexus to violate the law, infringe the rights of others,
          attempt unauthorized access, interfere with service operation, or
          upload harmful or abusive content.
        </p>

        <h2>Your account and content</h2>
        <p>
          You are responsible for keeping your email-and-password credentials
          and any linked Google or GitHub sign-in methods secure, and for
          activity that occurs through your account.
        </p>
        <p>
          You remain responsible for the content you upload, store, or generate
          in Nexus and for ensuring you have the rights needed to use that
          content.
        </p>
        ...
        <h2>Questions</h2>
        <p>
          Questions about these terms should be sent to the operator who
          provided access.
        </p>
