...
describe("Media page reader-scoped styles", () => {
  it("prefers reader tokens for EPUB TOC and status states", () => {
    renderReaderScopedElements({
      ...
      "--surface-2": "rgb(1, 2, 3)",
      "--ink": "rgb(7, 8, 9)",
      "--ink-muted": "rgb(11, 12, 13)",
      "--ink-faint": "rgb(14, 15, 16)",
      "--edge": "rgb(17, 18, 19)",
      "--edge-subtle": "rgb(21, 22, 23)",
      "--accent": "rgb(24, 25, 26)",
    } as CSSProperties);
  ...
  it("falls back to global tokens outside reader-scoped contexts", () => {
    renderReaderScopedElements({
      "--surface-2": "rgb(31, 32, 33)",
      "--ink": "rgb(37, 38, 39)",
      "--ink-muted": "rgb(41, 42, 43)",
      "--ink-faint": "rgb(44, 45, 46)",
      "--edge": "rgb(47, 48, 49)",
      "--edge-subtle": "rgb(51, 52, 53)",
      "--accent": "rgb(54, 55, 56)",
    } as CSSProperties);
