      ...
      sources: [
        {
          ...
          source_ref: {
            ...
            result_ref: {
              ...
              source_label: null,
              snippet: "Use the context assembler as the only chat prompt path.",
              deep_link: "/conversations/conversation-1#message-10",
              context_ref: { type: "message", id: "message-10" },
              source_version: "message:message-10",
              locator: {
