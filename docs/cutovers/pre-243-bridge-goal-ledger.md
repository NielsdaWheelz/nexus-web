...
| `dc1f1d184ae16dbabd65c8d52c9d80db6b4e29c2` | required forward port | resource-action-parity journey must await exact requested route and active media region before using mobile controls; baseline can accidentally target old browse pane. | test-control machinery separate; excluded journey/runtime owner removed under #254 |
...
| `1e544f00e2a030c68775c97c03a89beab73bdf48` | required forward port | same mobile parity goal as dc1f1d: bind mobile banner to exact reader heading and invoke its More control; banner is outside media region. | test-control machinery separate; excluded journey/runtime owner removed under #254 |
...
| `4438b1d4b14105c703945a10a4fefd7607648192` | already present | baseline sensitivity.py:574 preserves any explicit ::node before canonicalizing whole-file selections. | historical test goal; excluded machinery removed under #254 |
