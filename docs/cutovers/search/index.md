...
> **Archived design (2026-07-28).** The implementation branch was abandoned and
> is not part of `main`. These documents are retained as design input for a fresh
> cutover. Revalidate every status, owner, migration number, and code path before
> reuse; any “live” or “shipped” claim below describes the abandoned branch, not
> the current system.
