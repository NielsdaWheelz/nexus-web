...
status: proposed for user review, 2026-09-14; implementation paused.
supersedes execution of [the monolithic spec](bounded-workspace-implementation.md).
...
no new implementation starts until this plan is reviewed.
