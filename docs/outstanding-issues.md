...
- [open] latest model end-to-end proof · 2026-09-25 model cutover · 15 codex and 41 api browser cells pass; anthropic retention, brave result and auth refresh remain: [ticket](tickets/latest-model-end-to-end-qualification-incomplete.md).
- [open] latest model worker replay · 2026-09-26 cutover qualification · accepted paid child to parent publication crash window remains unqualified: [ticket](tickets/latest-model-worker-replay-not-qualified.md).
