...
- [open] latest model end-to-end proof · 2026-09-25 model cutover · 15 codex cells and browser-to-worker replay/isolation remain unqualified: [ticket](tickets/latest-model-end-to-end-qualification-incomplete.md).
