...
- [open] latest model end-to-end proof · 2026-09-25 model cutover · historical 15 codex and 41 api browser cells and a800 worker replay pass; codex tool authority blocks final chat/background admission, and final-pin, anthropic, brave, and auth-refresh proofs remain: [ticket](tickets/latest-model-end-to-end-qualification-incomplete.md).
- [open] codex frozen mcp authority · 2026-09-26 pinned 0.157.1 source audit · resource helpers escape the frozen tool list; tool-bearing codex stays ineligible: [ticket](tickets/codex-frozen-mcp-authority-not-enforced.md).
