...
- [open] oi-152 · schema · 2026-09-17 slop sweep · p3 · migration 0234 dropped the swept columns and tables; `artifact_build_failures.support` waits on oi-157's wire removal: [ticket](tickets/dead-schema-columns-await-one-migration.md).
