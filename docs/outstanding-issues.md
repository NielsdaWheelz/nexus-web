...
- [open] oi-142 · generation and ingest repair · 2026-09-17 slop sweep · p3 · seven uncertain-generation reconcilers and the internal ingest routes have no caller, route or job; delete or give them one entry point: [ticket](tickets/operator-repair-surfaces-have-no-entry-point.md).
...
- [open] oi-154 · python db models · 2026-09-17 slop sweep · p3 · 33 unimported classes, 26 unread relationships, 15 unused enums and every inert __table_args__ block: [ticket](tickets/models-py-mirrors-a-schema-nothing-reads.md).
- [open] oi-155 · web panes · 2026-09-17 slop sweep · p3 · six panes copy one revalidation settlement protocol; extract useRevalidationSettlement and preserve the PaneShell contract: [ticket](tickets/pane-revalidation-settlement-is-written-six-times.md).
...
- [open] oi-158 · conversation context refs · 2026-09-17 slop sweep · p3 · deleting addContextRef leaves the context-refs POST chain with no producer: [ticket](tickets/context-refs-post-loses-its-only-producer.md).
