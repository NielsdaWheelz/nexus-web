...
- [open] runtime availability · 2026-09-18 deployment preflight · background restart count 148 and a healthy postgres container's oom flag have unexplained histories: [ticket](tickets/production-container-exit-history-unexplained.md).
