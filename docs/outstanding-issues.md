...
- [open] latest model end-to-end proof · 2026-09-25 model cutover · 15 codex and 41 api browser cells and a800 worker crash replay pass; anthropic retention, brave result, auth refresh, codex authority and final-pin review remain: [ticket](tickets/latest-model-end-to-end-qualification-incomplete.md).
