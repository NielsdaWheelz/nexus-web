...
- [open] oi-129 · appearance · 2026-09-15 ecbe manual check · p2 · solar/dark switches save but crash the workspace without server oom; source fix prepared, manual acceptance pending: [ticket](tickets/workspace-theme-switch-crashes-after-save.md).
