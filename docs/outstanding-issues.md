...
- [open] latest model end-to-end proof · 2026-09-25 model cutover · 15 codex browser-to-worker cells and replay/isolation remain unqualified: [ticket](tickets/latest-model-end-to-end-qualification-incomplete.md).
