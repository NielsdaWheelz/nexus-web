...
- [open] oi-112 · production capacity · 2026-09-15 pr #255 qualification · p1 · legacy host fails memory admission and lacks the restoration backup reserve: [ticket](tickets/legacy-host-cannot-admit-restoration-capacity.md).
- [open] oi-113 · interactive worker · 2026-09-15 pr #255 qualification · p2 · startup reaches the 256 mib cap without oom; explain reclaim pressure and qualify representative work: [ticket](tickets/interactive-worker-startup-reaches-memory-cap.md).
