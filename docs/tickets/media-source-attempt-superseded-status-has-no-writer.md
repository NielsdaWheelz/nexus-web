...
Migration 0226 must state every extant attempt as a history baseline outcome
...
(`test_0226_preflight_rejects_an_uncatalogued_attempt_error_code` proves the
...
The status CHECK admits exactly the statuses a writer produces, and 0226's
