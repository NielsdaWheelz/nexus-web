...
| reader (epub, pdf, web article, selection/highlights; MediaPaneBody 7.6k, PdfReader 3.6k) | 46.3k | 15k | reauthor: one reader shell, one find | initial-content ownership unified; unicode selection, painting, find, and margin mapping share provenance; full reauthoring open; python reader core landed (size/reader-core-py): 3.2k→2.3k, −28% |
