...
class ApiErrorCode(str, Enum):
    ...
    E_METADATA_AGENT_QUOTA_EXHAUSTED = "E_METADATA_AGENT_QUOTA_EXHAUSTED"  # 429
    E_METADATA_AGENT_INVALID_OUTPUT = "E_METADATA_AGENT_INVALID_OUTPUT"  # 502
    E_METADATA_AGENT_TIMEOUT = "E_METADATA_AGENT_TIMEOUT"  # 504
    E_METADATA_AGENT_CANCELLED = "E_METADATA_AGENT_CANCELLED"  # 499
    E_METADATA_AGENT_AUTH_UNAVAILABLE = "E_METADATA_AGENT_AUTH_UNAVAILABLE"  # 503
    E_METADATA_AGENT_CAPACITY_UNAVAILABLE = "E_METADATA_AGENT_CAPACITY_UNAVAILABLE"  # 503
    E_METADATA_AGENT_HOST_UNAVAILABLE = "E_METADATA_AGENT_HOST_UNAVAILABLE"  # 503
    E_METADATA_AGENT_HOST_REJECTED = "E_METADATA_AGENT_HOST_REJECTED"  # 502
    E_METADATA_AGENT_POLICY_VIOLATION = "E_METADATA_AGENT_POLICY_VIOLATION"  # 502
    E_METADATA_AGENT_RUNTIME_FAILED = "E_METADATA_AGENT_RUNTIME_FAILED"  # 502
    E_METADATA_AGENT_SOURCE_CHANGED = "E_METADATA_AGENT_SOURCE_CHANGED"  # 409
    E_METADATA_AGENT_UNCERTAIN = "E_METADATA_AGENT_UNCERTAIN"  # 409
...
ERROR_CODE_TO_STATUS: dict[ApiErrorCode, int] = {
    ...
    ApiErrorCode.E_METADATA_AGENT_QUOTA_EXHAUSTED: 429,
    ApiErrorCode.E_METADATA_AGENT_INVALID_OUTPUT: 502,
    ApiErrorCode.E_METADATA_AGENT_TIMEOUT: 504,
    ApiErrorCode.E_METADATA_AGENT_CANCELLED: 499,
    ApiErrorCode.E_METADATA_AGENT_AUTH_UNAVAILABLE: 503,
    ApiErrorCode.E_METADATA_AGENT_CAPACITY_UNAVAILABLE: 503,
    ApiErrorCode.E_METADATA_AGENT_HOST_UNAVAILABLE: 503,
    ApiErrorCode.E_METADATA_AGENT_HOST_REJECTED: 502,
    ApiErrorCode.E_METADATA_AGENT_POLICY_VIOLATION: 502,
    ApiErrorCode.E_METADATA_AGENT_RUNTIME_FAILED: 502,
    ApiErrorCode.E_METADATA_AGENT_SOURCE_CHANGED: 409,
    ApiErrorCode.E_METADATA_AGENT_UNCERTAIN: 409,
    # Image proxy errors
