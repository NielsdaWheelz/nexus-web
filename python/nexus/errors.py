...
class ApiErrorCode(str, Enum):
    ...
    E_SINGLETON_TARGET_FORBIDDEN = "E_SINGLETON_TARGET_FORBIDDEN"
    ...
    E_SINGLETON_UNDELETABLE = "E_SINGLETON_UNDELETABLE"
...
ERROR_CODE_TO_STATUS: dict[ApiErrorCode, int] = {
    ...
    ApiErrorCode.E_SINGLETON_TARGET_FORBIDDEN: 403,
    ...
    ApiErrorCode.E_SINGLETON_UNDELETABLE: 409,
    # Highlight errors
