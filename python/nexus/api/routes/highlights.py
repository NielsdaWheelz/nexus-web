...
@router.get("/media/{media_id}/pdf-highlights/index")
def list_pdf_highlights_index(
    ...
    """List PDF highlights across a document with cursor pagination."""
    from nexus.services.pdf_highlights import list_pdf_highlights_index as svc_list_index
    ...
    highlights, page = svc_list_index(
        db=db,
        viewer_id=viewer.user_id,
        media_id=media_id,
        limit=limit,
