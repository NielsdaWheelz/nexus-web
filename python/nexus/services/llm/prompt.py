"""Prompt rendering for LLM requests.

Handles system prompt and context rendering for quote-to-chat.

Per S3 spec:
- System prompt v1 (versioned for tracking)
...
# System prompt content (per S3 spec)
...
def render_system_prompt() -> str:
    """Return the system prompt for LLM requests."""
