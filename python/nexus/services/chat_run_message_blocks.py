    ...
    return [
        {
            ...
            "id": str(row[0]),
            "message_id": str(assistant_message_id),
            "retrieval_status": row[1],
            "support_status": row[2],
            "verifier_status": row[3],
            "claim_count": row[5],
            "supported_claim_count": row[6],
            "unsupported_claim_count": row[7],
            "not_enough_evidence_count": row[8],
            "prompt_assembly_id": str(row[9]) if row[9] is not None else None,
            "verifier_run_id": str(row[4]) if row[4] is not None else None,
