...
def render_system_prompt_block() -> str:
    ...
    return (
        ...
        "When <subject>, <resources>, or <reader_selection> already contain enough "
        "evidence, answer from them without app_search. "
        ...
        "For broad comparison, absence, or multi-hop questions, make several focused "
        "app_search calls instead of one vague search. "
        "Do not mix private app_search evidence with public web_search evidence unless "
        "the user explicitly asks to combine saved sources with the web. "
        "Use web_search only for public web or outside-source discovery. "
