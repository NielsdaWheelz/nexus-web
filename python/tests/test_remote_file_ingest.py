...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://www.gutenberg.org/ebooks/1321.epub3", "epub"),
        ("https://www.gutenberg.org/ebooks/1321.epub3.images", "epub"),
        ("https://www.gutenberg.org/ebooks/1321.epub3.noimages?download=1", "epub"),
        ("https://example.com/book%2Eepub3", "epub"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://example.com/article?download=book.epub3",
        "https://arxiv.org/pdf/",
