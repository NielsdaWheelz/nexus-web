...
NUMBERING NOTE: rechained onto 0186 at merge (the persistence half was authored
against 0183, but main advanced first with 0184 remove-user-pinned-objects,
0185 podcast-listening `last_engaged_at`, and 0186 library reading-time word
counts — all orthogonal to the llm_calls/chat_runs/models/user_api_keys tables
